...
const Personalized_Learning = () => {
    return (
        <div className="flex w-full md:flex-row flex-col justify-center items-center px-4">
            <div className="md:w-2/5 w-full md:flex order-1 md:order-2 items-center justify-center">
                <Lottie
            ...
            <div className="md:w-2/4 w-full flex flex-col order-2 md:order-1 md:pl-12 md:pr-6 px-2 py-2 gap-3">
